 ...
 * @author  burgetr
 */
public class CustomBrowserCanvas extends JPanel
{
	private static final long serialVersionUID = -8715215920271505397L;
    private static Logger log = LoggerFactory.getLogger(CustomBrowserCanvas.class);
    ...
    protected int bufferedImageType = BufferedImage.TYPE_INT_ARGB;
     ...
     */
    public CustomBrowserCanvas(org.w3c.dom.Element root, DOMAnalyzer decoder, URL baseurl)
    {
        this.root = root;
     ...
     * @param bit BufferedImage type
     * @param baseurl the document base URL   
     */
    public CustomBrowserCanvas(org.w3c.dom.Element root,
                         DOMAnalyzer decoder,
                         Dimension dim, int bit, URL baseurl)
    {
    ...
    public void setBufferedImageType (int bit) {
        bufferedImageType = bit;
    }
    /**
    ...
    {
        if (createImage)
            img = new BufferedImage(dim.width, dim.height, bufferedImageType);
